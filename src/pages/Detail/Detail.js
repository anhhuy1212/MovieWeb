                    ...
                    <div className="col-span-4 col-start-4">
                        <div className="grid grid-cols-2">
                            ...
                            <div style={{ marginTop: '25%' }}>
                                ...
                                <p className="text-4xl text-color">{filmDetail.tenPhim}</p>
                                <p> {filmDetail.moTa}</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-2 p-12">
                        <div class={`c100 p${filmDetail.danhGia * 10} medium`}>
                                                ...
                                                return (
                                                    <div key={index}>
                                                        <div className="flex flex-row">
                                                            <img style={{ width: 50, height: 50 }} src={'https://s3img.vcdn.vn/123phim/2018/09/ddc-dong-da-15379624326697.jpg'} />
                                                            <div className="ml-2">
                                                                <p style={{ fontSize: 20, fontWeight: 'bold', lineHeight: 1 }}>{cumRap.tenCumRap}</p>
                                                                <p className="text-gray-300" style={{ marginTop: -5 }}>{cumRap.diaChi}</p>
                                                            </div>
                                                        </div>
